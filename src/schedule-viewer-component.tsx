        ...
        <table className="min-w-full">
          ...
          <tbody className="divide-y">
            {mockData.scheduleItems
              ...
              .map((item) => {
                const timeSlot = mockData.timeSlots.find(
                  (t) => t.id === item.timeSlot
                );
                return (
      ...
      <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg flex items-start space-x-3">
        ...
        <div>
          ...
          <div className="text-sm text-gray-600 mt-1">
            Обратите внимание, что преподавателю Каримовой Н.Д. потребуется 15
            минут для перемещения из Корпуса естественных наук в Главный корпус
