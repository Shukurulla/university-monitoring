...
import { ChevronDown, Filter, Download, Search, UserPlus, Edit, Trash2 } from 'lucide-react';
...
const TeacherWorkloadModule = () => {
  ...
  const mockData = {
    departments: ['Все', 'Информатика', 'Математика', 'Физика', 'Иностранные языки'],
    teachers: [
      { id: 1, name: "Рахимов А.К.", department: "Информатика", position: "Доцент", workload: 820, subjects: 4 },
      { id: 2, name: "Исмаилов С.Т.", department: "Математика", position: "Профессор", workload: 760, subjects: 3 },
      { id: 3, name: "Каримова Н.Д.", department: "Физика", position: "Преподаватель", workload: 640, subjects: 5 },
      { id: 4, name: "Бекназаров К.Р.", department: "Информатика", position: "Старший преподаватель", workload: 720, subjects: 4 },
      { id: 5, name: "Жумабаева Н.О.", department: "Иностранные языки", position: "Доцент", workload: 680, subjects: 6 }
    ],
    subjects: [
      { id: 1, name: "Программирование", hours: 240, groups: 3, type: "Лекция + практика" },
      { id: 2, name: "Базы данных", hours: 180, groups: 2, type: "Лекция + лаборатория" },
      { id: 3, name: "Высшая математика", hours: 320, groups: 4, type: "Лекция + практика" },
      { id: 4, name: "Физика", hours: 240, groups: 3, type: "Лекция + лаборатория" },
      { id: 5, name: "Английский язык", hours: 360, groups: 6, type: "Практика" }
    ]
  };
        ...
        <table className="min-w-full">
          <thead>
            <tr className="bg-gray-50 text-left">
              <th className="px-6 py-3 text-gray-500 font-medium text-sm">ФИО</th>
              <th className="px-6 py-3 text-gray-500 font-medium text-sm">Кафедра</th>
              <th className="px-6 py-3 text-gray-500 font-medium text-sm">Должность</th>
              <th className="px-6 py-3 text-gray-500 font-medium text-sm">Дисциплины</th>
              <th className="px-6 py-3 text-gray-500 font-medium text-sm">Часы</th>
            ...
            <table className="min-w-full">
              <thead>
                <tr className="bg-gray-100 text-left">
                  <th className="px-4 py-3 text-gray-500 font-medium text-sm">Название</th>
                  <th className="px-4 py-3 text-gray-500 font-medium text-sm">Тип занятий</th>
                  <th className="px-4 py-3 text-gray-500 font-medium text-sm">Группы</th>
                  <th className="px-4 py-3 text-gray-500 font-medium text-sm">Часы</th>
                </tr>
              </thead>
              <tbody className="divide-y">
                <tr>
                ...
                <tr>
                  <td className="px-4 py-3 font-medium">Алгоритмы и структуры данных</td>
                  <td className="px-4 py-3">Лекция + практика</td>
                  <td className="px-4 py-3">2 (Информ-201, 202)</td>
                  <td className="px-4 py-3 font-medium">160</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-medium">Информационная безопасность</td>
                  <td className="px-4 py-3">Лекция + практика</td>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <table className="min-w-full">
          <thead>
            <tr className="bg-gray-50 text-left">
              <th className="px-6 py-3 text-gray-500 font-medium text-sm">Название</th>
              <th className="px-6 py-3 text-gray-500 font-medium text-sm">Тип</th>
              <th className="px-6 py-3 text-gray-500 font-medium text-sm">Группы</th>
              <th className="px-6 py-3 text-gray-500 font-medium text-sm">Часы</th>
  ...
  const renderTabContent = () => {
    switch(activeTab) {
      case 'list': return <TeachersList />;
      case 'detail': return <TeacherDetail />;
      case 'subjects': return <SubjectDistribution />;
      default: return <TeachersList />;
    }
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold">Управление нагрузкой преподавателей</h2>
      </div>
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="border-b">
          <div className="flex">
            <button 
              className={`px-6 py-3 font-medium text-sm ${activeTab === 'list' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500'}`}
              onClick={() => setActiveTab('list')}
            >
              Список преподавателей
            </button>
            <button 
              className={`px-6 py-3 font-medium text-sm ${activeTab === 'detail' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500'}`}
              onClick={() => setActiveTab('detail')}
            >
              Детальный просмотр
            </button>
            <button 
              className={`px-6 py-3 font-medium text-sm ${activeTab === 'subjects' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500'}`}
