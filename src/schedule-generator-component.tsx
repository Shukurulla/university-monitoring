  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow p-6">
        <h3 className="text-xl font-medium mb-6">Автоматическая генерация расписания</h3>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600 mt-1">
                Убедитесь, что все нагрузки преподавателей распределены и установлены все необходимые параметры в настройках. Автоматическая генерация расписания может занять некоторое время.
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="pl-8 text-sm text-gray-600">
                    Проверка корректности нагрузки преподавателей и доступности аудиторий
                  </div>
                </div>
                <div>
                  <div className="flex items-center mb-1">
                ...
                <div>
                  <div className="flex items-center mb-1">
                    <div className="w-6 h-6 rounded-full bg-gray-300 text-white flex items-center justify-center text-xs mr-2">3</div>
                ...
                <div>
                  <div className="flex items-center mb-1">
                    <div className="w-6 h-6 rounded-full bg-gray-300 text-white flex items-center justify-center text-xs mr-2">4</div>
                    <div className="font-medium text-gray-500">Проверка конфликтов</div>
                  </div>
                  <div className="pl-8 text-sm text-gray-500">
                ...
                <div>
                  <div className="flex items-center mb-1">
                    <div className="w-6 h-6 rounded-full bg-gray-300 text-white flex items-center justify-center text-xs mr-2">5</div>
                    <div className="font-medium text-gray-500">Формирование расписания</div>
                  </div>
                  <div className="pl-8 text-sm text-gray-500">
          ...
          <table className="min-w-full">
            <thead>
              <tr className="bg-gray-50">
                <th className="px-4 py-2 text-left text-gray-500 font-medium text-sm">Дата</th>
                <th className="px-4 py-2 text-left text-gray-500 font-medium text-sm">Семестр</th>
                <th className="px-4 py-2 text-left text-gray-500 font-medium text-sm">Статус</th>
                <th className="px-4 py-2 text-left text-gray-500 font-medium text-sm">Действия</th>
              </tr>
            </thead>
            <tbody className="divide-y">
              <tr>
                ...
                <td className="px-4 py-3">
                  <span className="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs">Успешно</span>
                </td>
                <td className="px-4 py-3">
                  <button className="text-blue-500 hover:underline">Просмотр</button>
                </td>
              </tr>
              <tr>
                ...
                <td className="px-4 py-3">Весенний семестр 2024-2025</td>
                <td className="px-4 py-3">
                  <span className="px-2 py-1 bg-red-100 text-red-800 rounded-full text-xs">Ошибка</span>
                </td>
                <td className="px-4 py-3">
                  <button className="text-blue-500 hover:underline">Подробности</button>
                </td>
              </tr>
              <tr>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <div className="text-sm text-gray-600">
            Улучшение по сравнению с предыдущей версией: <span className="text-green-600 font-medium">+8%</span>
          </div>
        </div>
      </div>
    </div>
